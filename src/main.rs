...
const CONTROL_OWL_FINGERPRINT: &str = "C88E6F25736AD83DA1C757B22524C8FEB60EFCB0";
const QR2M_KEY_ID: &str = "99204764AC6B6A44";
const QR2M_FINGERPRINT: &str = "DE396887555C656B991D768E99204764AC6B6A44";
...
fn create_security_window(
    ...
    let our_key_box = gtk::Box::new(gtk::Orientation::Horizontal, 10);
