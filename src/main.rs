...
struct GuiState {
    ...
    gui_main_buttons: std::sync::Arc<
        std::sync::Mutex<std::collections::HashMap<String, Vec<std::sync::Arc<gtk::Button>>>>,
    >,
...
impl GuiState {
    fn default_config() -> Self {
        Self {
            ...
            gui_log_status: None,
            gui_main_buttons: std::sync::Arc::new(std::sync::Mutex::new(
...
impl AppSettings {
    fn load_settings() {
        ...
        application_settings.wallet_mnemonic_length = wallet_mnemonic_length.clone();
...
fn create_main_window(
    ...
    let advance_search_label =
        gtk::Label::new(Some(&t!("UI.main.coin.search.advance").to_string()));
    ...
    let generate_addresses_button =
        gtk::Button::with_label(&t!("UI.main.address.generate").to_string());
    ...
    let delete_addresses_button =
        gtk::Button::with_label(&t!("UI.main.address.generate.clean").to_string());
    ...
    let stop_address_generation_button =
        gtk::Button::with_label(&t!("UI.main.address.generate.stop").to_string());
    ...
    // Address count
    let address_options_frame =
        gtk::Frame::new(Some(&t!("UI.main.address.options.count").to_string()));
    ...
    // Address start
    let address_start_frame =
        gtk::Frame::new(Some(&t!("UI.main.address.options.start").to_string()));
    ...
    let address_options_hardened_address_frame =
        gtk::Frame::new(Some(&t!("UI.main.address.options.hardened").to_string()));
...
fn create_settings_window(
    ...
    let default_gui_theme_color_label =
        gtk::Label::new(Some(&t!("UI.settings.general.theme").to_string()));
    ...
    let default_gui_icons_label =
        gtk::Label::new(Some(&t!("UI.settings.general.icons").to_string()));
    ...
    let default_gui_language_label =
        gtk::Label::new(Some(&t!("UI.settings.general.language").to_string()));
    ...
    let save_window_size_label =
        gtk::Label::new(Some(&t!("UI.settings.general.save_window").to_string()));
    ...
    let default_search_parameter_label =
        gtk::Label::new(Some(&t!("UI.settings.general.search").to_string()));
    ...
    let notification_timeout_label = gtk::Label::new(Some(
        &t!("UI.settings.wallet.notification_timeout").to_string(),
    ));
    ...
    let default_gui_log_level_label =
        gtk::Label::new(Some(&t!("UI.settings.general.log_level").to_string()));
